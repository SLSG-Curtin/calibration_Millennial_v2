...
#source("/projects/mingxi/calibration_mm2/d02_script/check_equilirum_state_new.R")

#source("/projects/mingxi/calibration_mm2/d02_script/MM_v2_new.R")

#source("/media/DATADRIVE1/Model/Millennial/calibration_mm2/d02_script/MM_v3.R")
source("/projects/mingxi/calibration_mm2/d02_script/MM_v3.1.R")
################################################################################
#parameters        <- NULL
...
#
inputs <- read.csv("/projects/mingxi/calibration_mm2/d01_data/input/continental_input_sites_update.txt")
...
flist <- list.files("/projects/mingxi/calibration_mm2/d01_data/rangeland_daily_driving/",full.names = TRUE,recursive = TRUE)
...
pars.list <- foreach(i=seq(flist),.packages = c("rtop","dplyr","magrittr","FME","doParallel","deSolve","zoo","rsq")) %dopar% {
...
names(pars_outs) <- selected_params$Parameter

names(pars_outs)[14] <- 'value'
...
saveRDS(pars_outs,"/projects/mingxi/calibration_mm2/d03_output/sitebysite_benchmark_pars_outs_ode_100y_0526_init.rds")
